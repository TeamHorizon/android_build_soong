...
func (c *config) JavaSourceOverlays() string {
	return String(c.productVariables.Xenonhd.Java_Source_Overlays)
}

func (c *config) JavaSourceOverlayModuleWhitelist() []string {
	return android.XenonhdConfig.JavaSourceOverlayModuleWhitelist
}
...
func (c *deviceConfig) SpecificCameraParametersLibrary() string {
	return String(c.config.productVariables.Xenonhd.Specific_camera_parameter_library)
}
